...
function PIN() {
  ...
  let stl = {
    ...
    numbers:
      "border-2 border-secondary p-2 w-[50px] aspect-square cursor-pointer flex items-center justify-center rounded-full hover:bg-secondary hover:text-white duration-300",
  };
    ...
    <div className={stl.size}>
      ...
      <div className={stl.container} id="shadow">
        ...
        <div className="w-[400px] h-[400px] border-2 border-blue-400 grid grid-cols-3 gap-[20px] place-items-center p-3">
          <div className={stl.numbers} onClick={TypeNumber}>
            1
          </div>
          <div className={stl.numbers} onClick={TypeNumber}>
            2
        ...
        <button className={stl.btn} onClick={SubmitPassword}>
          Submit
        </button>
        {/* </Link> */}
      </div>
